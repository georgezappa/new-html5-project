...
dependencies:
  ...
  debug: 4.3.4
  ejs: 3.1.8
  eslint-config-standard: 14.1.1_6pxh33c6yz7obcbdz7xgcxf5bu
  eslint-plugin-standard: 5.0.0_eslint@8.35.0
  express: 4.18.2
  http-errors: 2.0.0
  morgan: 1.10.0
  node-sass-middleware: 1.0.1
...
packages:
  ...
  /@jest/core/29.4.3:
    ...
    dependencies:
      ...
      jest-config: 29.4.3_@types+node@18.14.4
  ...
  /@types/node-sass-middleware/0.0.32:
    resolution: {integrity: sha512-dcJccrNH8qyx9NfOI5D+yntM/WfdKXLVFlZOqHKMf9tP7NU3yatbko1QqF9SVxfMA/aajG/ywrDbhcV1HVMMQg==}
    dependencies:
      '@types/express': 4.17.17
  ...
  /node-sass-middleware/1.0.1:
    resolution: {integrity: sha512-zkm02Hv9uxduYnWn+iZACw8rMs5OvvKbhACv0q61JQNefhETHznNWN5uiwdiYdb58zsIYcdJ4szbc6UeAOXodQ==}
    engines: {node: '>=12.0.0'}
    dependencies:
      node-sass: 7.0.3
    transitivePeerDependencies:
  ...
  /node-sass/8.0.0:
    resolution: {integrity: sha512-jPzqCF2/e6JXw6r3VxfIqYc8tKQdkj5Z/BDATYyG6FL6b/LuYBNFGFVhus0mthcWifHm/JzBpKAd+3eXsWeK/A==}
    engines: {node: '>=14'}
    hasBin: true
    requiresBuild: true
    dependencies:
